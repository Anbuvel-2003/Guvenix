...
const Navbar = () => {
        ...
        },
        {
            ...
            dropdown: [
                ...
                },
                {
                    ...
                    path: "DevOpsSection",
                    description:
                        "Streamlined development, deployment, automation, and scalability",
                },
            ],
            isHorizontal: true,
        },
    ...
    return (
        <nav
            className={`fixed top-0 w-full z-50 transition-all duration-300 bg-primary ${isVisible ? "translate-y-0" : "-translate-y-full"
                }`}
        >
            <div className="  px-4">
                <div className="flex  lg:justify-start justify-between w-[95vw]  items-center h-16">
                    ...
                    <div className="flex-shrink-0 ml-32 lg:!pl-20 hidden lg:block ">
                        <h2 className="uppercase text-sm font-syne text-white ">Guvenix Technologies</h2>
                    </div>
                    <div className="flex-shrink-0 ml-32 md:!pt-5 !pt-3 md:!pl-20 !pl-10 lg:hidden block ">
                        <h2 className="uppercase text-[20px] font-syne text-white ">Guvenix</h2>
                    </div>
                    ...
                    >
                        {navLinks.map((link, index) => (
                            ...
                            >
                                <a
                                    href={link.path}
                                    className="relative group flex items-center uppercase text-sm font-syne text-white 
    hover:text-transparent hover:bg-gradient-to-r hover:from-indigo-500 hover:to-cyan-400 hover:bg-clip-text transition-all duration-700 ease-in-out"
            ...
            {isMobileMenuOpen && (
                <div className="lg:hidden bg-white rounded-b-lg shadow-lg">
                    <div className="px-2 pt-2 pb-3 space-y-1 md:!pl-20 !pl-10">
                        {navLinks.map((link, index) => (
                            <div key={index}>
